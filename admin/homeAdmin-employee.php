    ...
    <script>
        ...
        window.onload=function(){
            document.getElementById('tblDataTable').onclick = function(event){
                ...
                $("#txtEmailId").val(cells[3].innerHTML);
        ...
        function validate()
        {
            ...
            if(firstName.length==0 || lastName.length==0 || mNo.length==0 || email.length==0 )
            {
        ...
        function addEmployee()
        {
            ...
            form.action='/foodManagementSystem/employee/addEmployeeDB.php';
            form.method='post';
            form.submit();
        }
        ...
        function deleteEmployee()
        {
            if(!validate()) return;
            form=document.getElementById('myForm');
            form.action='/foodManagementSystem/employee/deleteEmployeeDB.php';
            form.method='post';
            form.submit();
        }
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h6> * If you add employee, password will be set to "1234" by default</h6>
                    <div class="row">
