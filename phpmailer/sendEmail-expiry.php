...
$mail->Subject = 'Food Expiry Alert';
$mail->Body    = 'This is reminder mail, that some food are going to expired soon. These are following foods whose expiry date is close : '.$_SESSION["food_name"];
