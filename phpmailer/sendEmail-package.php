...
$mail->Subject = 'Food Package Ready';
$mail->Body    = 'Your requested food package is ready, ordered from Community FoodManagementSystem with food name as '.$_POST["food_name"].' and food quantity as '.$_POST["quantity"];
