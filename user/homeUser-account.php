...
$k="select * from regular_user where email_id='".$_SESSION["uLogin"]."'";
...
<head>
    ...
    <script>
        function validate2()
        {
            ...
            var sNo=$("#txtSocialInsuranceNo").val();
            var address=$("#txtAddress").val();
            if(id.length==0 || name.length==0 || lastName.length==0 || email.length==0 || mNo.length==0 || password.length==0 || sNo.length==0 || address.length==0)
            {
        ...
        function updateUser()
        {
            ...
            form.action='/foodManagementSystem/user/updateUserDB.php';
            form.method='post';
            form.submit();
        }
        </script>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form id="myForm">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <input type="text" class="form-control form-control-user" id="txtSocialInsuranceNo" name="txtSocialInsuranceNo" placeholder="Social Insurance Number"  value="<?php echo $row["social_insurance_number"] ?>">
                        </div>
                        <div class="col-sm-4">
                            <input type="text" class="form-control form-control-user" id="txtEmailId" name="txtEmailId" placeholder="Mobile Number" value="<?php echo $row["email_id"] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <input type="email" class="form-control form-control-user" id="txtAddress" name="txtAddress" placeholder="Email Id"  value="<?php echo $row["address"] ?>">
                        </div>
                        <div class="col-sm-4">
